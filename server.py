...
def update(entity):
    ...
    # Get the body of the post request using the helper method
...
def get_entity(entity):
    ...
    # Return the entity requested from the world
    json_entity_repr = jsonify(myWorld.get(entity))
    return json_entity_repr
